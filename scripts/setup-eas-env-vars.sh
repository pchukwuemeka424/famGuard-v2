...
echo "5. GOOGLE_SERVICES_API_KEY (Firebase / google-services.json)"
echo "6. EXPO_PUBLIC_DELETE_ACCOUNT_URL (optional)"
echo ""
...
echo "eas env:create --scope project --name GOOGLE_SERVICES_API_KEY --value 'YOUR_FIREBASE_ANDROID_API_KEY' --environment production"
